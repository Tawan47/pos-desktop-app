...
// Component ย่อยสำหรับแสดงผล Barcode (ไม่มีการแก้ไข)
...
const BarcodeGenerator = ({ products = [] }) => {
    ...
    const isBarcodeValid = productToPreview && productToPreview.barcode && String(productToPreview.barcode).length === 13;

    return (
        <div className="p-4 sm:p-6 lg:p-8 font-sans space-y-8">
            <h1 className="text-3xl font-bold text-gray-800">เครื่องสร้างบาร์โค้ดและการพิมพ์</h1>
